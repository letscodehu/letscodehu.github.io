...
function buildReport(data) {
  ...
  const summary = computed(() => {
    ...
    return [
      ...
      `A verifikáció terhe nem nő együtt a használattal. A legnagyobb terhet a <b>középmezőny</b> viseli (${hu(reviewArch.value.peak.mean)}/5), az AI-native-ok a legkisebbet (${hu(reviewArch.value.low.mean)}/5). Ez nem bizonyítja, hogy az AI könnyebbé teszi a review-t — inkább azt jelzi, hogy a rutin és a kialakult ellenőrzési szokások számítanak.`,
