...
export const blogPostManifest: BlogPostManifest[] = [
  {
    slug: 'you-dont-need-five-databases',
    publishedAt: '2026-08-26',
    tags: ['architecture', 'scaling'],
    videoUrl: 'https://youtu.be/GMlOd7xiZdQ',
    featuredImagePath: '/blog/fivevspostgres.png',
    titleEn: "You Don't Need Five Databases (Yet)",
    titleHu: 'Nem kell öt adatbázis (még)',
    excerptEn:
      "An architecture diagram gives you two options: five specialized systems, or one Postgres instance doing all five jobs. Postgres genuinely can run your queue, search, vectors, cron, and event log - until connection pressure, vacuum lag, or buffer cache contention gives you a real, measured reason to split one out.",
    excerptHu:
